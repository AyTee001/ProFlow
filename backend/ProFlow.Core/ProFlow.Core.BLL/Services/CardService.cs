...
namespace ProFlow.Core.BLL.Services
{
    public class CardService : BaseService, ICardService
    {
        ...
        {
            var card = await _mongoContext.Cards.GetById(cardId);
        ...
        public async Task DeleteCardChecklistByIdAsync(DeleteInfo checklistDeleteInfo)
        {
        ...
        public async Task<Checklist> CreateCardChecklistAsync(string cardId)
        {
            ...
            {
                await DeleteCardChecklistByIdAsync(new DeleteInfo { Id = checklist.Id, Version = checklist.Version});
                throw;
            }
